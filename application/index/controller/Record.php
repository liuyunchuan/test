...
class Record extends Base
{
	...
	public function recordExport()
	{
        ...
        for($i = 0; $i < count($epl); $i++)
        {
            ...
            $objExcel->getActiveSheet()->setCellValueExplicit('B'.($i+2),$epl[$i]['address']);
            ...
            $objExcel->getActiveSheet()->setCellValueExplicit('F'.($i+2),$epl[$i]['start_time']);
            $objExcel->getActiveSheet()->setCellValueExplicit('G'.($i+2),$epl[$i]['end_time']);
            $objExcel->getActiveSheet()->setCellValueExplicit('H'.($i+2),$epl[$i]['visittype']);
            $objExcel->getActiveSheet()->setCellValueExplicit('I'.($i+2),$epl[$i]['account']);
            $objExcel->getActiveSheet()->setCellValueExplicit('J'.($i+2),$epl[$i]['car_num']);
        }
